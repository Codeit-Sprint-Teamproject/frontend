...
export default function PendingReviewBox() {
  ...
  return (
    <>
      <div className='w-[360px] p-5 border rounded-md'>
        <div className='flex flex-col gap-4'>
          ...
          <Link
            href='/reviews/write'
            className='h-12 p-3 text-center text-customGreen-600 border border-customGreen-100 rounded-md'
          >
            리뷰 작성하기
          </Link>
        </div>
      </div>
      <div className='flex justify-center items-center gap-3 mt-[18px]'>
        <button
        ...
        <p className='text-sm text-customGrey-800'>
          작성하지 않은 리뷰{' '}
          <span className='font-bold ml-1'>{currentIndex + 1}</span> /{' '}
