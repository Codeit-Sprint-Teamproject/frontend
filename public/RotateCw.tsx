...
interface RotateCwProps {
  width: number
  height: number
}

const RotateCw = ({width, height}:RotateCwProps) => {
  return (
    <>
      <svg width={`${width}px`} height={`${height}px`} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M23 4V10H17" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
